    ...
    try {
      ...
      recorder.onstop = async () => {
        ...
        try {
          ...
          console.log("[UI] ✨ Iniciando polimento...");
          const polished = await polishText(text);

          console.log("[UI] ✅ Processo concluído.");
          ...
          if (errorMessage.includes("API") || errorMessage.includes("quota") || errorMessage.includes("créditos")) {
            setTimeout(() => {
